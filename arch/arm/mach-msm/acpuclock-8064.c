...
static struct l2_level l2_freq_tbl[] __initdata __initdata = {
    [0]  = { {  192000, PLL_8, 0, 2, 0x00 }, 800000, 850000, 1 },
    [1]  = { {  288000, HFPLL, 0, 2, 0x20 }, 950000, 950000, 1 },
	[2]  = { {  384000, HFPLL, 0, 2, 0x24 }, 950000, 950000, 1 },
	[3]  = { {  486000, HFPLL, 2, 0, 0x28 }, 950000, 950000, 2 },
	[4]  = { {  540000, HFPLL, 2, 0, 0x16 }, 950000, 950000, 2 },
	[5]  = { {  594000, HFPLL, 1, 0, 0x18 }, 950000, 950000, 2 },
	[6]  = { {  648000, HFPLL, 1, 0, 0x1A }, 950000, 950000, 4 },
	[7]  = { {  702000, HFPLL, 1, 0, 0x1C }, 950000, 950000, 4 },
	[8]  = { {  756000, HFPLL, 1, 0, 0x1E }, 1050000, 1050000, 4 },
	[9]  = { {  810000, HFPLL, 1, 0, 0x20 }, 1050000, 1050000, 4 },
	[10]  = { {  864000, HFPLL, 1, 0,0x22 }, 1050000, 1050000, 4 },
	[11] = { {  918000, HFPLL, 1, 0, 0x24 }, 1050000, 1050000, 5 },
	[12] = { {  972000, HFPLL, 1, 0, 0x26 }, 1050000, 1050000, 5 },
	[13] = { { 1026000, HFPLL, 1, 0, 0x28 }, 1050000, 1050000, 5 },
	[14] = { { 1080000, HFPLL, 1, 0, 0x2A }, 1050000, 1050000, 5 },
	[15] = { { 1134000, HFPLL, 1, 0, 0x2C }, 1050000, 1050000, 5 },
	[16] = { { 1188000, HFPLL, 1, 0, 0x2E }, 1050000, 1050000, 5 },
};
...
static struct acpu_level acpu_freq_tbl_slow[] __initdata = {
	...
	{ 1, {  1026000, HFPLL, 1, 0, 0x28 }, L2(6),  1025000 },
...
static struct acpu_level acpu_freq_tbl_nom[] __initdata = {
    { 1, {   192000, PLL_8, 0, 2, 0x00 }, L2(0),   800000 },
