...
static struct l2_level l2_freq_tbl[] __initdata __initdata = {
    [0]  = { {  162000, PLL_8, 0, 2, 0x00 }, 850000, 850000, 1 },
    [1]  = { {  288000, HFPLL, 0, 2, 0x20 }, 975000, 975000, 1 },
	[2]  = { {  384000, HFPLL, 0, 2, 0x24 }, 1000000, 1000000, 1 },
	[3]  = { {  486000, HFPLL, 2, 0, 0x28 }, 1000000, 1000000, 2 },
	[4]  = { {  540000, HFPLL, 2, 0, 0x16 }, 1000000, 1000000, 2 },
	[5]  = { {  594000, HFPLL, 1, 0, 0x18 }, 1000000, 1000000, 2 },
	[6]  = { {  648000, HFPLL, 1, 0, 0x1A }, 1000000, 1000000, 4 },
	[7]  = { {  702000, HFPLL, 1, 0, 0x1C }, 1000000, 1000000, 4 },
	[8]  = { {  756000, HFPLL, 1, 0, 0x1E }, 1100000, 1100000, 4 },
	[9]  = { {  810000, HFPLL, 1, 0, 0x20 }, 1100000, 1100000, 4 },
	[10]  = { {  864000, HFPLL, 1, 0,0x22 }, 1100000, 1100000, 4 },
	[11] = { {  918000, HFPLL, 1, 0, 0x24 }, 1100000, 1100000, 5 },
	[12] = { {  972000, HFPLL, 1, 0, 0x26 }, 1100000, 1100000, 5 },
	[13] = { { 1026000, HFPLL, 1, 0, 0x28 }, 1100000, 1100000, 5 },
	[14] = { { 1080000, HFPLL, 1, 0, 0x2A }, 1100000, 1100000, 5 },
	[15] = { { 1134000, HFPLL, 1, 0, 0x2C }, 1100000, 1100000, 5 },
	[16] = { { 1188000, HFPLL, 1, 0, 0x2E }, 1100000, 1100000, 5 },
};

static struct acpu_level acpu_freq_tbl_slow[] __initdata = {
    { 1, {   162000, PLL_8, 0, 2, 0x00 }, L2(0),   850000 },
    { 1, {   288000, HFPLL, 0, 2, 0x20 }, L2(0),   900000 },
	//{ 0, {   384000, HFPLL, 0, 2, 0x20 }, L2(6),   875000 },
	//{ 1, {   486000, HFPLL, 2, 0, 0x24 }, L2(6),   875000 },
	{ 1, {   540000, HFPLL, 2, 0, 0x16 }, L2(6),   950000 },
	//{ 1, {   594000, HFPLL, 1, 0, 0x16 }, L2(6),   900000 },
	//{ 0, {   648000, HFPLL, 1, 0, 0x18 }, L2(6),  925000 },
	{ 1, {   702000, HFPLL, 1, 0, 0x1C }, L2(6),  975000 },
