...
static struct l2_level l2_freq_tbl[] __initdata __initdata = {
    [0]  = { {  124000, PLL_8, 0, 2, 0x00 }, 850000, 850000, 1 },
...
static struct acpu_level acpu_freq_tbl_slow[] __initdata = {
    { 1, {   124000, PLL_8, 0, 2, 0x00 }, L2(0),   875000 },
...
static struct acpu_level acpu_freq_tbl_nom[] __initdata = {
    { 1, {   124000, PLL_8, 0, 2, 0x00 }, L2(0),   850000 },
	...
	{ 1, {  1188000, HFPLL, 1, 0, 0x2E }, L2(15), 1125000 },
...
static struct acpu_level acpu_freq_tbl_fast[] __initdata = {
    { 1, {    81000, HFPLL, 0, 2, 0x0C }, L2(0),   775000 },
    { 1, {   124000, PLL_8, 0, 2, 0x00 }, L2(0),   800000 },
...
static struct acpu_level acpu_freq_tbl_faster[] __initdata = {
    { 1, {    81000, HFPLL, 0, 2, 0x0C }, L2(0),   750000 },
    { 1, {   124000, PLL_8, 0, 2, 0x00 }, L2(0),   775000 },
    { 1, {   288000, HFPLL, 0, 2, 0x20 }, L2(0),   800000 },
    //{ 0, {   384000, HFPLL, 0, 2, 0x20 }, L2(6),   775000 },
    //{ 1, {   486000, HFPLL, 2, 0, 0x24 }, L2(6),   775000 },
    { 1, {   540000, HFPLL, 2, 0, 0x16 }, L2(6),   850000 },
    //{ 1, {   594000, HFPLL, 1, 0, 0x16 }, L2(6),   800000 },
